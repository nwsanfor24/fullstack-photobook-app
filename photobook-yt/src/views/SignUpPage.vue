<template>
    <div>
        <form v-if="!confirmedPassword" class="flex flex-cool items-center" @submit.prevent="signUp">
            <div class="flex flex-col user">
                <label class="block text-gray-700 text-sm font-bold md-2" for="userName">User Name</label>
                <input
